...
import { Trophy, Target, Gift, TrendingUp, Calendar, Star, Zap, Award } from "lucide-react"
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-lg mb-6 opacity-90">
              Tu tienda está en la <strong>Liga de Plata</strong>. ¡Sigue mejorando para alcanzar el Oro!
            </p>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Card className="bg-white/15 border-white/20 backdrop-blur-sm">
              <CardContent className="p-4 text-center">
                <Trophy className="w-8 h-8 mx-auto mb-2 text-[#A4D4D8]" />
                <div className="text-2xl font-bold">Plata</div>
                <div className="text-sm opacity-90">Liga Actual</div>
              </CardContent>
            </Card>
            <Card className="bg-white/15 border-white/20 backdrop-blur-sm">
              <CardContent className="p-4 text-center">
                <Target className="w-8 h-8 mx-auto mb-2 text-[#A4D4D8]" />
                <div className="text-2xl font-bold">3</div>
                <div className="text-sm opacity-90">Retos Activos</div>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="flex justify-between text-sm">
              ...
              <span className="text-[#F97659] font-bold">820 puntos restantes</span>
            </div>
            ...
            <div className="p-4 bg-gradient-to-r from-[#A4D4D8]/20 to-[#4DB9E8]/20 rounded-lg border border-[#4DB9E8]/30">
              <p className="text-sm text-[#1A1926] font-medium">
                🎯 ¡Estás muy cerca! Completa 2 retos más esta semana para avanzar a la Liga de Oro.
              </p>
            </div>
          </div>
        </CardContent>
        ...
        <Card className="hover:shadow-xl transition-all duration-300 group border-2 border-transparent hover:border-[#c31f39]/20">
          <Link href="/challenges">
            <CardContent className="p-6 text-center">
              ...
              <h3 className="text-lg font-semibold mb-2 text-[#1A1926]">Retos Disponibles</h3>
              <p className="text-gray-600 text-sm mb-3">3 nuevos retos esperándote</p>
        ...
        <Card className="hover:shadow-xl transition-all duration-300 group border-2 border-transparent hover:border-[#4DB9E8]/20">
          <Link href="/rewards">
            <CardContent className="p-6 text-center">
              ...
              <h3 className="text-lg font-semibold mb-2 text-[#1A1926]">Mis Recompensas</h3>
              <p className="text-gray-600 text-sm mb-3">Ver puntos y beneficios</p>
        ...
        <Card className="hover:shadow-xl transition-all duration-300 group border-2 border-transparent hover:border-[#F97659]/20">
          <Link href="/leagues">
            <CardContent className="p-6 text-center">
              ...
              <h3 className="text-lg font-semibold mb-2 text-[#1A1926]">Mi Liga</h3>
              <p className="text-gray-600 text-sm mb-3">Ver ranking y competencia</p>
