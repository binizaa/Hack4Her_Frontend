...
import { Users, TrendingUp, Target, Award, BarChart3, MapPin, Calendar, Activity } from "lucide-react"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-[#c31f39]">Panel Admin - Tuali</h1>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-[#c31f39]">{campaignStats.totalUsers}</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-[#c31f39]">{campaignStats.activeUsers}</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-[#c31f39]">{campaignStats.completedChallenges}</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-[#c31f39]">{campaignStats.totalEngagement}%</p>
                </div>
        ...
        <Tabs defaultValue="regions" className="space-y-6">
          <TabsList>
            ...
            <TabsTrigger value="challenges">Rendimiento de Desafíos</TabsTrigger>
                ...
                <div className="space-y-4">
                  {regionData.map((region, index) => (
                    <div key={index} className="grid grid-cols-1 md:grid-cols-4 gap-4 p-4 border rounded-lg">
                      <div>
                        <h3 className="font-semibold text-[#c31f39]">{region.region}</h3>
                        <p className="text-sm text-gray-600">{region.stores} tiendas</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600">Engagement</p>
                        <div className="flex items-center space-x-2">
                          <Progress value={region.engagement} className="flex-1" />
                          <span className="text-sm font-medium">{region.engagement}%</span>
                        </div>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600">Puntos Promedio</p>
                        <p className="text-lg font-semibold">{region.avgPoints}</p>
                      </div>
                      <div className="flex items-center">
                        <Badge
                          className={`${
                        ...
                        >
                          {region.engagement > 80 ? "Excelente" : region.engagement > 70 ? "Bueno" : "Mejorable"}
                        </Badge>
                      </div>
                    </div>
                  ))}
                ...
                <div className="space-y-6">
                  {challengePerformance.map((challenge, index) => (
                    <div key={index} className="space-y-2">
                      ...
                      <div className="flex items-center space-x-4">
                        <Progress value={challenge.completion} className="flex-1" />
                        <span className="text-sm font-medium w-12">{challenge.completion}%</span>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg">
                      <span className="font-medium">Incremento Promedio en Ventas</span>
                      <span className="text-2xl font-bold text-green-600">+15.3%</span>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
                      <span className="font-medium">Diversificación de Inventario</span>
                      <span className="text-2xl font-bold text-blue-600">+23%</span>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-purple-50 rounded-lg">
                      <span className="font-medium">Adopción de Nuevos Productos</span>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div>
                      <div className="flex justify-between mb-2">
                        <span className="text-sm">Usuarios Activos Diarios</span>
